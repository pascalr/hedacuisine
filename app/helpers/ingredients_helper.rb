module IngredientsHelper
  ...
  def scalable_ingredient(ing)
    ...
    content_tag :span, id: "ingredient-#{ing.id}", data: {"scalable-ingredient": true, grams: qty.grams, ml: qty.ml, total: qty.total, raw: ing.raw, "food-name-singular": ing.food.name, "food-name-plural": ing.food.plural, preposition: pretty_preposition(ing.food), "food-id": ing.food.id, "comment": replace_links(ing.comment)} do
  ...
  def scalable_detailed_ingredient(ing)
    qty = ing.quantity_model
    content_tag :span, id: "ingredient-#{ing.id}", class: "ingredient-list-item", data: {"scalable-ingredient-detailed": true, grams: qty.grams, ml: qty.ml, total: qty.total, raw: ing.raw, "food-name-singular": ing.food.name, "food-name-plural": ing.food.plural, preposition: pretty_preposition(ing.food), "food-id": ing.food.id, "comment": replace_links(ing.comment)} do
