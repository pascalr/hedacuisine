class ThemesController < ApplicationController
  ...
  private
    ...
    def theme_params
      params.require(:theme).permit(:name, :background_color, :text_color, :font_name, :page_separator_color, :inverted_background_color, :inverted_text_color, :link_color, :link_missing_color, :front_page_image_id)
    end
end
