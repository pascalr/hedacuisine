class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      p = params.require(:recipe).permit(:name, :source, :instructions, :version_name, :group_id, :complete_instructions, :image_id, :raw_servings, :preparation_time, :cooking_time)
